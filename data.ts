...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      'Live Coursera Streamlit project upgraded into a professional risk-aware ML product with a unified dark theme, interactive diagnostics, model comparison, threshold policy, scoring, and governance documentation.',
    category: 'Risk Classification',
    technologies: ['Streamlit', 'Python', 'scikit-learn', 'Plotly', 'Model Governance', 'Threshold Policy'],
    status: 'Live public ML app',
    demoUrl: 'https://ayman-stat-mushroom-safety-classifier-streamlit-app-jeedwt.streamlit.app/',
    ...
    details: [
      'Refactors the original Coursera lab into a clean, relative-path, portfolio-ready Streamlit product with a unified dark theme and interactive Plotly diagnostics.',
